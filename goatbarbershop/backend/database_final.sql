...
-- Desliga checagens de FK para permitir a troca em paz
SET FOREIGN_KEY_CHECKS = 0;

-- 1) Mover os usuários para IDs temporários (evita colisão)
UPDATE usuarios SET id = 9001 WHERE id = 2;
UPDATE usuarios SET id = 9002 WHERE id = 3;
UPDATE usuarios SET id = 9003 WHERE id = 4;

-- 2) Atualizar as referências nas tabelas filhas direto para os IDs finais
--    2 -> 1, 3 -> 2, 4 -> 3
UPDATE agendamentos            SET barbeiro_id = 1 WHERE barbeiro_id = 2;
UPDATE agendamentos            SET barbeiro_id = 2 WHERE barbeiro_id = 3;
UPDATE agendamentos            SET barbeiro_id = 3 WHERE barbeiro_id = 4;

UPDATE barbeiro_servicos       SET barbeiro_id = 1 WHERE barbeiro_id = 2;
UPDATE barbeiro_servicos       SET barbeiro_id = 2 WHERE barbeiro_id = 3;
UPDATE barbeiro_servicos       SET barbeiro_id = 3 WHERE barbeiro_id = 4;

UPDATE disponibilidade_barbeiro SET barbeiro_id = 1 WHERE barbeiro_id = 2;
UPDATE disponibilidade_barbeiro SET barbeiro_id = 2 WHERE barbeiro_id = 3;
UPDATE disponibilidade_barbeiro SET barbeiro_id = 3 WHERE barbeiro_id = 4;

-- 3) Trazer os usuários dos temporários para os IDs finais
UPDATE usuarios SET id = 1 WHERE id = 9001;
UPDATE usuarios SET id = 2 WHERE id = 9002;
UPDATE usuarios SET id = 3 WHERE id = 9003;
...
UPDATE usuarios SET senha_hash = '$2a$10$kJHW2teH3cIijGqzXIdTS.7G8mGIzCgVD1nhrscPhwPBpPB2SA4Km' 
WHERE tipo_usuario = 'barbeiro';

UPDATE horarios_funcionamento SET horario_fechamento = '18:00:00' 
...
-- Remover referências dos serviços duplicados
...
update usuarios set tipo_usuario = 'admin' where id = 9004;
