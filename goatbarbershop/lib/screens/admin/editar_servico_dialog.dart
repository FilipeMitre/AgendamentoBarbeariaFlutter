...
class EditarServicoDialog extends StatefulWidget {
  final ServicoModel servico;

  const EditarServicoDialog({
    super.key,
    required this.servico,
  });

  @override
  State<EditarServicoDialog> createState() => _EditarServicoDialogState();
}

class _EditarServicoDialogState extends State<EditarServicoDialog> {
  ...
  void initState() {
    ...
    _precoController = TextEditingController(text: widget.servico.preco.toStringAsFixed(2));
    _duracaoController = TextEditingController(text: widget.servico.duracaoMinutos.toString());
  ...
  Future<void> _salvarAlteracoes() async {
    if (_formKey.currentState!.validate()) {
      ...
      final sucesso = await adminProvider.atualizarServico(
        widget.servico.id,
      ...
      if (mounted) {
        ...
        if (sucesso) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(adminProvider.errorMessage ?? 'Erro ao atualizar serviço'),
